...
To allow accessible exploration of the meteorite landing data, a Shiny application was developed to visualize the geospatial values. The application can be accessed [here](https://gmcginnis.shinyapps.io/MeteoriteMap/).
