...
earth_orbit <- read.csv('daily_orbitals/earth.csv')
flora_orbit <- read.csv('daily_orbitals/8flora.csv')
hebe_orbit <- read.csv('daily_orbitals/6hebe.csv')
vesta_orbit <- read.csv('daily_orbitals/4vesta.csv')
itokawa_orbit <- read.csv('daily_orbitals/itokawa.csv')
