...
To allow accessible exploration of the meteorite landing data, a Shiny application was also developed to visualize the asteroids. The application can be accessed [here](https://jgaiser.shinyapps.io/app1/).

[![A screenshot of the asteroids map application, including filtering options, outputted time series, and an interactive 3D orbital map.](images/shiny_asteroids_sample.png)](https://jgaiser.shinyapps.io/app1/)
