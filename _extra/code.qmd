...
```{r filter for size, warning=FALSE, fig.alt= "World map showing the different recorded locations where meteorites fell to Earth"}
...
```{r warning=FALSE, fig.alt= "World map showing the different recorded locations of meteorites before falling"}
