...
The high-level goal for using Shiny app in the Meteorite_Landings dataset is to create an interactive platform that allows users to explore and analyze meteorite landings data through dynamic visualizations.
...
-   What trends may be observed in frequency, type, or location of meteors, and can they be related to known celestial events? 
