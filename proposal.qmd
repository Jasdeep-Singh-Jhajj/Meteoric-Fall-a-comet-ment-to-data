...
- All 'NULL' values would be ignored for Question 1, which deals with plotting the locations of each reporting on an interactive map. But these values could prove valuable for Questions 2 & 3 and will therefore be left in the dataset for them.
